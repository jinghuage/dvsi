Ext.define('DVSI.view.D3NetworkChart', {
    extend: 'Ext.form.Panel',
    alias: 'widget.networkchart',
    title: 'd3 force network chart property',
    autoScroll: true,
    //collapsible: true,
    ...
    initComponent: function() {
        console.log("view.D3NetworkChart initComponent");
    ...
    apply: function(chartid, data, selection) {
        console.log("view.D3NetworkChart draw");
        ...
        var drawchart = d3.chart.networkChart();
        ...
        if(selection.length > 0) {
            ...
            console.log(" selectedItems for network chart: ", selection);
